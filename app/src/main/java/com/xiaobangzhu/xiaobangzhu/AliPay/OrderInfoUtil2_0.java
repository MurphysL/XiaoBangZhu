...
public class OrderInfoUtil2_0 {
	 ...
	 * @return
	 */
	public static Map<String, String> buildOrderParamMap(String app_id , float total_amount , String subject , String body) {
		Map<String, String> keyValues = new HashMap<String, String>();

		keyValues.put("app_id", app_id);

		keyValues.put("biz_content", "{\"timeout_express\":\"30m\",\"product_code\":\"QUICK_MSECURITY_PAY\"," +
				"\"total_amount\":\"0.01\",\"subject\":\"" + subject +"\",\"body\":\"" + body +"\",\"out_trade_no\":\"" + getOutTradeNo() +  "\"}");
